				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="page-title">
							<h2 class="page-title__title">Hello, it's Parker.<br>
								
								<!-- typing__module -->
								<div class="typing__module">
									<div class="typed-strings"><span>Click around the site</span><span> to learn more</span><span>about what I do.</span>
